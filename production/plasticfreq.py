...
ARG1 = int(sys.argv[1]) # freqs, infinite options
ARG2 = int(sys.argv[2]) # geometry, 12 options
ARG3 = int(sys.argv[3]) # tauRef, 21 options
...
inputs['tauRef'] = [10. ** i for i in np.linspace(5, 6, 21)][ARG3]

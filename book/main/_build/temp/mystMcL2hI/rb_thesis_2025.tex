...
% Crazy chatbot shit here - caveats abound:

% Demote all heading levels by one
...
\renewcommand{\section}[1]{\oldsection{#1}}       % Normally this would be \chapter
\renewcommand{\subsection}[1]{\oldsubsection{#1}} % Normally this would be \section

% Force the level mapping
\usepackage{titlesec}
